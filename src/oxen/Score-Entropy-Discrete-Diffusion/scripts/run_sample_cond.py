...
sys.path.append('/home/sdanisetty/projects/advpur/repos/oxen/Score-Entropy-Discrete-Diffusion/')
...
def main():
    ...
    input_locs = list(range(len(prefix_ids))) + list(range(50-len(suffix_ids), 50))
